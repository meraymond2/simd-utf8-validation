...
bool lookup_validate(const char *bytes, size_t len) {
    ...
    __m128i mask_vec = _mm_set1_epi8(15);
...
//    __m128i masked = _mm_and_si128(v1, _mm_set1_epi8(240))
    __m128i shifted = _mm_(_mm_and_si128(v1, _mm_set1_epi8(240), )
...
//        // todo shift!
//        __m128i byte_1_high = _mm_shuffle_epi8(table1, prev1);
//        __m128i masked = _mm_and_si128(prev1, mask_vec);
//        __m128i byte_1_low = _mm_shuffle_epi8(table2, prev1);
//        // todo shift!
//        __m128i byte_2_high = _mm_shuffle_epi8(table3, v1);
//
//        volatile __m128i anded = _mm_and_si128(_mm_and_si128(byte_1_high, byte_1_low), byte_2_high);
